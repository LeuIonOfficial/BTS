            ...
            <div className="flex h-16 justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex items-center space-x-2 text-gray-500 font-bold rounded-full p-2 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#059e9b] focus:ring-offset-2">
                      <span>{user?.name}</span>
                      <img
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                {/* Mobile menu button */}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#059e9b]">
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <div className="border-t border-gray-200 pb-3 pt-4">
              <div className="flex items-center px-4">
                ...
                <button
                  type="button"
                  className="relative ml-auto flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#059e9b] focus:ring-offset-2"
                >
